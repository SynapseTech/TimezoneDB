		...
		>
			...
			>
				...
				<h2 class="mt-2 text-gray-600 text-xl text-center">
					An easy, cross-platform method of keeping track of other
					people's timezones.
				</h2>
				...
				<div class="grid grid-cols-1 lg:grid-cols-4 gap-2">
					...
					>
						<img
							...
							class="object-fill max-h-96"
						/>
						<span
							class="absolute bottom-0 w-full text-center bg-black bg-opacity-40 text-white p-1 backdrop-blur-sm rounded-b"
						>
