<template>
  <div class="flex flex-col container mx-auto bg-white h-full">
    <main class="flex flex-col flex-grow p-4">
      <h1 class="text-3xl mb-4 font-bold">TimezoneDB Extension Settings</h1>
      ...
      <div class="mt-2 flex items-center">
        ...
        <button class="btn red ml-2" @click="clear">
          Clear Settings
        </button>
      </div>
    </main>

    <footer class="bg-gray-300 border-gray-400 border-t-[1px] border-opacity-10 text-gray-600 flex items-center justify-center flex-grow-0 py-2">
...
async function save() {
  let extensionSettings: ExtensionSettings = await browser.storage.sync.get('settings') as ExtensionSettings;
