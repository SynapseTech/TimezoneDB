...
export async function fetchTimezone(accountType: Account, id: string): Promise<ZoneInfo | 'unspecified'> {
    ...
    const res = await fetch(`${apiUrl}/v1/users/byPlatform/${accountType}/${id}`);
